...
public class CityMap extends Application {
    ...
    MuseumChallenge museumChallenge = new MuseumChallenge();
    ...
    /**
     * Adds a visual pane for a mketour.Challenge to the map.
    ...
    private void addEntities() {
        ...
        Museum store = new Museum(this);
        MuseumChallenge museumChallenge = new MuseumChallenge();
        museums.add(store);
        store.attach(museumChallenge);
        addChallengeNode(museumChallenge.getPane());
        MSOEChallenge msoeChallenge = new MSOEChallenge();
        mainCharacter.attach(msoeChallenge);
        addChallengeNode(msoeChallenge.getPane());
        EasterEggChallenge easterEggChallenge = new EasterEggChallenge();
        mainCharacter.attach(easterEggChallenge);
        addChallengeNode(easterEggChallenge.getPane());
        mobileEntities.add(mainCharacter);
