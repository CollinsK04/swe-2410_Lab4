...
import mketour.Observer;
import mketour.Subject;
 ...
 */
public abstract class MobileEntity implements Taggable, Subject {
    ...
    public void taggedBy(MobileEntity entity) {
        ...
        if ( CityMap.DEBUG_LEVEL >= 0 && !entity.equals(this)) {
